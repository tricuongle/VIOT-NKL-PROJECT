...
import LogItemQLDinhMuc from "./LogItemQLDinhMuc";
import axios from "axios";
import * as Config from "../../../untils/Config";
var arrayValueLog = [];
var load = [];

class LogContentQLDinhMuc extends Component {
  constructor(props) {
    super(props);
    this.state = {
      valueContentLog: [],
    ...
    return (
      <div className="content-wrapper">
        <section className="content-header">
          <h1>LỊCH SỬ QUẢN ĐỊNH MỨC MÃ CÁ</h1>
          <ol className="breadcrumb">
            ...
            <li className="active">Lịch sử quản lý định mức mã cá</li>
          </ol>
        </section>
...
export default LogContentQLDinhMuc;
