...
import LogItemQLMaCa from "./LogItemQLMaCa";
import axios from "axios";
import * as Config from "../../../untils/Config";
var arrayValueLog = [];
var load = [];

class LogContentQLMaCa extends Component {
  constructor(props) {
    super(props);
    this.state = {
      valueContentLog: [],
      ...
      <div className="content-wrapper">
        <section className="content-header">
          ...
          <ol className="breadcrumb">
            ...
            <li className="active">Lịch sử quản lý mã cá</li>
          </ol>
        </section>
...
export default LogContentQLMaCa;
