...
(function(a) {
    ...
    a.extend(m.prototype, {
        _constructor: function() {
            ...
            d.on("init.dtr", function(c, e, r) { "dt" === c.namespace && (b._resizeAuto(), b._resize(), a.inArray(!1, b.s.current) && d.columns.adjust()) });
            this._resize()
        },
        _columnsVisiblity: function(b) {
            var d = this.s.dt,
                c = this.s.columns,
                e, f = c.map(function(a, b) { return { columnIdx: b, priority: a.priority } }).sort(function(a, b) {
                    return a.priority !==
            ...
            var b = this,
                ...
                g = function(a, c, g, l) {
                    if (!g) e[a].includeIn.push(c);
                        ...
                        for (c = 0, g = d.length; c < g; c++) - 1 === d[c].name.indexOf(l) &&
                            f(a, d[c].name)
                };
            e.each(function(b, c) {
                for (var e = b.className.split(" "), f = !1, h = 0, l = e.length; h < l; h++) {
                    ...
                    if ("all" === k) {
                        f = !0;
                        b.includeIn = a.map(d, function(a) { return a.name });
                        return
                    }
                    ...
                    a.each(d, function(a, b) {
                        a = b.name.split("-");
                        var d = k.match(new RegExp("(min\\-|max\\-|not\\-)?(" + a[0] + ")(\\-[_a-zA-Z0-9])?"));
                        d && (f = !0, d[2] === a[0] && d[3] === "-" + a[1] ? g(c, b.name, d[1], d[2] + d[3]) : d[2] !== a[0] || d[3] || g(c, b.name, d[1], d[2]))
                    })
                }
                f ||
                    (b.auto = !0)
        ...
        _detailsDisplay: function(b, d) {
            var c = this,
                e = this.s.dt,
                f = this.c.details;
            if (f && !1 !== f.type) { var g = f.display(b, d, function() { return f.renderer(e, b[0], c._detailsObj(b[0])) });!0 !== g && !1 !== g || a(e.table().node()).triggerHandler("responsive-display.dt", [e, b, g, d]) }
        },
        _detailsInit: function() {
            ...
            b._tabIndexes();
            a(d.table().body()).on("keyup.dtr",
                "td, th",
                function(b) { 13 === b.keyCode && a(this).data("dtr-keyboard") && a(this).click() });
            var e = c.target;
            c = "string" === typeof e ? e : "td, th";
            if (e !== n || null !== e) a(d.table().body()).on("click.dtr mousedown.dtr mouseup.dtr", c, function(c) {
        ...
        _detailsObj: function(b) {
            var d = this,
                c = this.s.dt;
            return a.map(this.s.columns, function(a, f) { if (!a.never && !a.control) return a = c.settings()[0].aoColumns[f], { className: a.sClass, columnIndex: f, data: c.cell(b, f).render(d.c.orthogonal), hidden: c.column(f).visible() && !d.s.current[f], rowIndex: b, title: a.sTitle } })
        },
        _find: function(a) {
        ...
        _resize: function(b) {
            ...
            var p = !1,
                q = 0;
            c.columns().eq(0).each(function(a, c) {!0 === m[c] && q++; if (b || m[c] !== n[c]) p = !0, d._setColumnVis(a, m[c]) });
            ...
            if ("inline" === this.c.details.type) {
                var t = a.inArray(!0, m);
                c.cells(null, function(a) { return a !== t }, { page: "current" }).nodes().to$().filter(".dtr-control").removeClass("dtr-control");
        ...
        _resizeAuto: function() {
            var b = this.s.dt,
                d = this.s.columns;
            if (this.c.auto && -1 !== a.inArray(!0, a.map(d, function(a) { return a.auto }))) {
                ...
                c.style.width = "auto";
                var g = b.columns().header().filter(function(a) { return b.column(a).visible() }).to$().clone(!1).css("display",
        ...
        _responsiveOnlyHidden: function() { var b = this.s.dt; return a.map(this.s.current, function(a, c) { return !1 === b.column(c).visible() ? !0 : a }) },
        _setColumnVis: function(b, d) {
            var c = this.s.dt;
            d = d ? "" : "none";
            a(c.column(b).header()).css("display", d);
            a(c.column(b).footer()).css("display", d);
            c.column(b).nodes().to$().css("display",
                d);
        ...
        _tabIndexes: function() {
            ...
            "number" === typeof e ? b.cells(null, e, { page: "current" }).nodes().to$().attr("tabIndex", c.iTabIndex).data("dtr-keyboard", 1) : ("td:first-child, th:first-child" === e && (e = ">td:first-child, >th:first-child"), a(e, b.rows({ page: "current" }).nodes()).attr("tabIndex",
    ...
    m.display = {
        childRow: function(b, d, c) {
            if (d) { if (a(b.node()).hasClass("parent")) return b.child(c(), "child").show(), !0 } else {
        ...
        childRowImmediate: function(b, d, c) {
            if (!d &&
                b.child.isShown() || !b.responsive.hasHidden()) return b.child(!1), a(b.node()).removeClass("parent"), !1;
            b.child(c(), "child").show();
            a(b.node()).addClass("parent");
            return !0
        },
    ...
    u.register("responsive.index()", function(b) { b = a(b); return { column: b.data("dtr-index"), row: b.parent().data("dtr-index") } });
    ...
    u.register("responsive.hasHidden()", function() { var b = this.context[0]; return b._responsive ? -1 !== a.inArray(!1, b._responsive._responsiveOnlyHidden()) : !1 });
